...
let{cashPayment ,setNumOfCartItem } = useContext(CartContext);
let navigate = useNavigate();
    ...
    async function cash(values){
        let {data} = await cashPayment(values);
        setNumOfCartItem(null);
        navigate('/allorders');
    }
return (<>
    ...
    <div className="container min-height">
        <div className="row bg-main-color p-4 my-5 rounded">
            ...
            <form onSubmit={formik.handleSubmit} >
                ...
                <button type='submit' className='btn-desgin btn btn-color text-white d-block ms-auto'>Buy Now</button>
            </form>
        </div>
    </div>
